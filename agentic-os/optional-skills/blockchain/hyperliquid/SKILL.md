...
version: 0.1.0
author: Hugo Sequier (Hugo-SEQUIER), Agentic OS
license: MIT
...
The script reads `${AGENTIC_OS_HOME:-~/.agentic-os}/.env` for two optional defaults:
...
Helper script: `~/.agentic-os/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python3 ~/.agentic-os/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `${AGENTIC_OS_HOME:-~/.agentic-os}/.env`.
...
```bash
python3 ~/.agentic-os/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python3 ~/.agentic-os/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
