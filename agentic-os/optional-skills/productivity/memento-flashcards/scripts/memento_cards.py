...
Data file: $AGENTIC_OS_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_AGENTIC_OS_HOME = Path(os.environ.get("AGENTIC_OS_HOME", Path.home() / ".hermes"))
DATA_DIR = _AGENTIC_OS_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
