...
def fake_homes(tmp_path, monkeypatch):
    """Point AGENTIC_OS_HOME at a temp profile dir.

    Uses the real env-var resolution chain (get_agentic_os_home /
    get_default_agentic_os_root) instead of monkeypatching private helpers —
    ...
    AGENTIC_OS_HOME=<root>/profiles/<name> makes get_default_agentic_os_root()
