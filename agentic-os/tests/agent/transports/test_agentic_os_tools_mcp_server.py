...
from agent.transports.agentic_os_tools_mcp_server import (
...
class TestModuleSurface:
    def test_module_imports_clean(self):
        from agent.transports import agentic_os_tools_mcp_server as m
    ...
    def test_exposed_tools_are_safe_subset(self):
        ...
        from agent.transports.agentic_os_tools_mcp_server import EXPOSED_TOOLS
        forbidden = {
...
class TestMain:
    def test_main_returns_2_when_mcp_unavailable(self, monkeypatch):
        ...
        import agent.transports.agentic_os_tools_mcp_server as m
