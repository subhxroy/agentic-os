...
from agentic_os_cli.main import _suppress_mouse_residue_early
...
class TestEarlyMouseDisable:
    def test_writes_disable_sequence_when_tui_flag_in_argv(self, monkeypatch):
        ...
        monkeypatch.delenv("AGENTIC_OS_TUI_NO_EARLY_DISABLE", raising=False)
    ...
    def test_writes_disable_sequence_when_hermes_tui_env_set(self, monkeypatch):
        ...
        monkeypatch.setenv("AGENTIC_OS_TUI", "1")
        monkeypatch.delenv("AGENTIC_OS_TUI_NO_EARLY_DISABLE", raising=False)
    ...
    def test_respects_diagnostic_escape_hatch(self, monkeypatch):
        ...
        monkeypatch.delenv("AGENTIC_OS_TUI", raising=False)
        monkeypatch.setenv("AGENTIC_OS_TUI_NO_EARLY_DISABLE", "1")
