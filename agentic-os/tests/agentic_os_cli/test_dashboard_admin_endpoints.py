...
def _client():
    ...
    # Keep the state DB under the isolated AGENTIC_OS_HOME for any handler that
    # touches it.
...
class TestMcpEndpoints:
    ...
    def _setup(self, _isolate_agentic_os_home):
...
class TestCredentialPoolEndpoints:
    ...
    def test_env_seeded_delete_stays_deleted(self):
        ...
        load_pool() re-seeds from ~/.agentic-os/.env on every call, so removing
