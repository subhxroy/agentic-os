...
def test_save_platform_tools_preserves_mcp_server_names():
    ...
    Regression test for https://github.com/subhxroy/agentic-os/issues/1247
    """
    config = {
        "platform_toolsets": {
...
class TestPlatformToolsetConsistency:
    ...
    def test_gateway_toolset_includes_all_messaging_platforms(self):
        """agentic-os-gateway includes list should cover all messaging platforms."""
        from agentic_os_cli.tools_config import PLATFORMS
        from toolsets import TOOLSETS

        gateway_includes = set(TOOLSETS["agentic-os-gateway"]["includes"])
...
def test_numeric_mcp_server_name_does_not_crash_sorted():
    ...
    Regression test for https://github.com/subhxroy/agentic-os/issues/6901
    """
    config = {
