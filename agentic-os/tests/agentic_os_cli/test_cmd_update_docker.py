...
from agentic_os_cli.main import _cmd_update_check, cmd_update
...
@patch("agentic_os_cli.config.detect_install_method", return_value="docker")
...
def test_cmd_update_in_docker_prints_guidance_and_exits(
    ...
    assert "docker pull subhxroy/agentic-os:latest" in out
...
def test_format_docker_update_message_contents():
    ...
    assert "docker pull subhxroy/agentic-os:latest" in msg
    ...
    assert "AGENTIC_OS_HOME" in msg or "/opt/data" in msg, (
