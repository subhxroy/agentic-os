...
class TestConfigFilePermissions(unittest.TestCase):
    ...
    def test_save_config_sets_0600(self):
        ...
        with patch("agentic_os_cli.config.get_config_path", return_value=config_path), \
             patch("agentic_os_cli.config.ensure_agentic_os_home"):
    ...
    def test_ensure_agentic_os_home_sets_0700(self):
