...
part of the bundled-plugins set; a stock agentic-os install does not see
an "Example" tab in its sidebar. The ``_install_example_plugin`` pytest
fixture in ``tests/agentic_os_cli/test_web_server.py`` copies this directory
into ``$AGENTIC_OS_HOME/plugins/example-dashboard/`` and forces the dashboard
