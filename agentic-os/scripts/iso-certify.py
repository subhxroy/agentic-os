...
the scratch AGENTIC_OS_HOME; ``--isolation on|off`` sets it. Run BOTH:
...
def main(argv: list[str] | None = None) -> int:
    ...
    p.add_argument("--isolation", choices=["on", "off"], default="on",
                   help="set dashboard.turn_isolation in the scratch AGENTIC_OS_HOME")
    ...
    p.add_argument("--keep-home", action="store_true", help="do not delete the scratch AGENTIC_OS_HOME on exit")
