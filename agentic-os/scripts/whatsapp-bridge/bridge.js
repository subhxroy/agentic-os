 ...
 *
 * Usage:
 *   node bridge.js --port 3000 --session ~/.agentic-os/whatsapp/session
 */
...
// env (AGENTIC_OS_HOME-aware, new cache/ layout).  Fall back to the legacy
...
const DEFAULT_REPLY_PREFIX = '⚕ *Agentic OS*\n────────────\n';
...
async function startSocket() {
  ...
  sock = makeWASocket({
    ...
    browser: ['Agentic OS', 'Chrome', '120.0'],
