#!/usr/bin/env bash
# Canonical test runner for agentic-os. Run this instead of calling
...
#   * Proper venv activation (probes .venv, venv, then ~/.agentic-os/...)
#
# Usage:
...
VENV=""
for candidate in "$REPO_ROOT/.venv" "$REPO_ROOT/venv" "$HOME/.hermes/agentic-os/venv"; do
