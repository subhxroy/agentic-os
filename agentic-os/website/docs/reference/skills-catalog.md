...
| [`agentic-os`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-agentic-os) | Configure, extend, or contribute to Agentic OS. | `autonomous-ai-agents/agentic-os` |
...
| Skill | Description | Path |
|-------|-------------|------|
| [`agentic-os-desktop-plugins`](/docs/user-guide/skills/bundled/agentic-os-desktop-plugins/agentic-os-desktop-plugins-agentic-os-desktop-plugins) | Write desktop app plugins that add UI panes and commands. | `agentic-os-desktop-plugins` |
...
| [`teams-meeting-pipeline`](/docs/user-guide/skills/bundled/productivity/productivity-teams-meeting-pipeline) | Operate the Teams meeting summary pipeline via Agentic OS CLI — summarize meetings, inspect pipeline status, replay jobs, manage Microsoft Graph subscriptions. | `productivity/teams-meeting-pipeline` |
...
| Skill | Description | Path |
|-------|-------------|------|
| [`agentic-os-skill-authoring`](/docs/user-guide/skills/bundled/software-development/software-development-agentic-os-skill-authoring) | Author in-repo SKILL.md: frontmatter, validator, structure, and writing-quality principles. | `software-development/agentic-os-skill-authoring` |
