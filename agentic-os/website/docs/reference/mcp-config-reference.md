...
description: "Reference for Agentic OS MCP configuration keys, filtering semantics, and utility-tool policy"
---
...
- Tokens are persisted to `~/.agentic-os/mcp-tokens/<server>.json` and reused across sessions
