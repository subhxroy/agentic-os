...
Hermes fetches curated model lists for **OpenRouter** and **Nous Portal** from a JSON manifest hosted alongside the docs site. This lets maintainers update picker lists without shipping a new `agentic-os` release.
...
Cache location: `~/.agentic-os/cache/model_catalog.json`.
