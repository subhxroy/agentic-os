...
sidebar_position: 16
title: "Yuanbao"
description: "Connect Agentic OS to the Yuanbao enterprise messaging platform via WebSocket gateway"
---
...
After initial setup, verify these variables in `~/.agentic-os/.env`:
...
4. Review gateway logs: `tail -f ~/.agentic-os/logs/gateway.log`
