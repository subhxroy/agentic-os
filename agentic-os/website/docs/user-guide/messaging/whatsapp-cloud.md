...
description: "Set up Agentic OS as a WhatsApp bot via Meta's official Business Cloud API"
---
...
Message-template support (the workaround for outside-window sends) is not yet implemented in Hermes. If you need it, please [open an issue](https://github.com/subhxroy/agentic-os/issues) — it's planned but waiting on a clear demand signal.
