...
title: "Git Worktrees"
description: "Run multiple Agentic OSs safely on the same repository using git worktrees and isolated checkouts"
---

# Git Worktrees

Agentic OS is often used on large, long‑lived repositories. When you want to:
