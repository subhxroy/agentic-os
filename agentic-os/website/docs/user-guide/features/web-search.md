...
Agentic OS includes two model-callable web tools backed by multiple providers:
...
Then select SearXNG as the search backend in `~/.agentic-os/config.yaml`:
...
source ~/.agentic-os/agentic-os/.venv/bin/activate
