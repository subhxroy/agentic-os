...
| Version | `0.1.0` |
| Author | Mibay (Mibayy), Agentic OS |
| License | MIT |
...
```
SCRIPT=~/.agentic-os/skills/finance/stocks/scripts/stocks_client.py
...
```
python3 ~/.agentic-os/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
