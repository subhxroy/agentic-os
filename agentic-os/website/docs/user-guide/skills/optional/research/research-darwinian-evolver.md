...
| Version | `0.1.0` |
| Author | Bihruze (Asahi0x), Agentic OS |
| License | MIT |
...
```bash
mkdir -p ~/.agentic-os/cache/darwinian-evolver && cd ~/.agentic-os/cache/darwinian-evolver
...
```bash
cd ~/.agentic-os/cache/darwinian-evolver/darwinian_evolver \
...
Open `~/.agentic-os/cache/darwinian-evolver/darwinian_evolver/darwinian_evolver/lineage_visualizer.html`
...
SKILL_DIR=~/.agentic-os/skills/research/darwinian-evolver
DE_DIR=~/.agentic-os/cache/darwinian-evolver/darwinian_evolver
...
7. **AGPL.** Never `from darwinian_evolver import ...` inside Hermes core.
   Custom driver scripts under `~/.agentic-os/skills/...` are user-side and fine.
