...
4. Name the token (e.g., "Agentic OS"), set an optional expiry, and click **Generate Token**
5. Copy the token and add to `${AGENTIC_OS_HOME:-~/.agentic-os}/.env`:
...
```bash
CANVAS="python $AGENTIC_OS_HOME/skills/productivity/canvas/scripts/canvas_api.py"
