...
| Version | `0.1.0` |
| Author | Matt Maximo (MattMaximo), Agentic OS |
| License | MIT |
| Platforms | linux, macos, windows |
| Tags | `Coding-Agent`, `Grok`, `xAI`, `Code-Review`, `Refactoring`, `Automation` |
| Related skills | [`codex`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-codex), [`claude-code`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-claude-code), [`agentic-os`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-agentic-os) |
