...
| Related skills | [`codex`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-codex), [`agentic-os`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-agentic-os), [`opencode`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-opencode) |
