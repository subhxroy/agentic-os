...
* Implementation: [`agent/plugin_llm.py`](https://github.com/subhxroy/agentic-os/blob/main/agent/plugin_llm.py)
* Tests: [`tests/agent/test_plugin_llm.py`](https://github.com/subhxroy/agentic-os/blob/main/tests/agent/test_plugin_llm.py)
