...
description: "How to build a web-search/extract/crawl backend plugin for Agentic OS"
---
...
2. **User** — `~/.agentic-os/plugins/web/<name>/` (opt-in via `plugins.enabled` or `hermes plugins enable <name>`)
