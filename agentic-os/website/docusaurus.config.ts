    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl: 'https://github.com/subhxroy/agentic-os/edit/main/website/',
        },
        blog: false,
        theme: {
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/subhxroy/agentic-os',
          label: 'GitHub',
          position: 'right',
        },
        {
      ...
      links: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'GitHub Issues', href: 'https://github.com/subhxroy/agentic-os/issues' },
