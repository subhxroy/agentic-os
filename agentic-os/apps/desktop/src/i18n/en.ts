...
export const en: Translations = {
  ...
  boot: {
    ready: 'Agentic OS Desktop is ready',
    ...
    steps: {
      ...
      startingHermesDesktop: 'Starting Agentic OS Desktop…'
    },
    errors: {
  ...
  notifications: {
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Agentic OS Desktop.',
  ...
  settings: {
    ...
    searchPlaceholder: {
      about: 'About Agentic OS Desktop',
    ...
    gateway: {
      ...
      intro:
        'Agentic OS Desktop starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running Hermes backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
      ...
      envOverrideDesc:
        'Unset AGENTIC_OS_DESKTOP_REMOTE_URL and AGENTIC_OS_DESKTOP_REMOTE_TOKEN to use the saved setting below.',
      ...
      restartingMessage: 'Agentic OS Desktop will reconnect using the saved settings — the shell stays open.',
  ...
  install: {
    ...
    oneTimeTitle: 'Agentic OS needs a one-time install',
    ...
    settingUpTitle: 'Setting up Agentic OS',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Agentic OS CLI or desktop instance is running. Stop any running Hermes instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
  ...
  onboarding: {
    headerTitle: "Let's get you setup with Agentic OS",
  ...
  assistant: {
    ...
    approval: {
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.agentic-os/config.yaml). Hermes won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'Agentic OS needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Agentic OS needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Agentic OS Desktop to use Save Image.',
    restartToSaveImages: 'Restart Agentic OS Desktop to save images',
