...
import { disconnectOAuthProvider, listOAuthProviders } from '@/agentic-os'
...
const canRunInTerminal = () => typeof window !== 'undefined' && Boolean(window.agenticOSDesktop?.terminal)
...
//      in agentic_os_cli/provider_catalog.py) — the SAME provider identity
