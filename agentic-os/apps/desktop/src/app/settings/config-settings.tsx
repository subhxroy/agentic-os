...
import type { ConfigFieldSchema, HermesConfigRecord } from '@/types/agentic-os'
...
export function ConfigSettings({
  ...
  const { data: loadedConfig, isError: configLoadFailed, refetch: refetchConfig } = useAgenticOSConfigRecord()
