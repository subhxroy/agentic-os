...
const STORAGE_KEY = 'agentic-os.desktop.layoutTree.v2'

writeKey('agentic-os.desktop.layoutTree.v1', null)
 ...
 */
export const $activePresetId = atom<string>(readKey('agentic-os.desktop.layoutPreset.active') ?? 'default')

export function markActivePreset(id: string) {
  $activePresetId.set(id)
  writeKey('agentic-os.desktop.layoutPreset.active', id)
}
 ...
 */
const DISMISSED_KEY = 'agentic-os.desktop.dismissedPanes.v1'
...
const USER_PLACED_KEY = 'agentic-os.desktop.userPlacedPanes.v1'
