 ...
 * plugins resolve `@agentic-os/plugin-sdk` through the vite alias; RUNTIME-loaded
...
export function sdkImportMap(): Record<string, string> {
  cached ??= {
    '@agentic-os/plugin-sdk': shimUrl('__AGENTIC_OS_PLUGIN_SDK__'),
