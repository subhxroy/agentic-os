 ...
 *
 * A public install can end up with `origin=git@github.com:subhxroy/agentic-os.git`.
...
const OFFICIAL_REPO_HTTPS_URL = 'https://github.com/subhxroy/agentic-os.git'
const OFFICIAL_REPO_CANONICAL = 'github.com/subhxroy/agentic-os'
