...
// even though a fresh shell — and the Agentic OS CLI — sees it immediately. The
// desktop's AGENTIC_OS_HOME resolution relies on process.env, so that stale-snapshot
// gap silently sends the backend to the default %LOCALAPPDATA%\agentic-os. Reading
...
//       AGENTIC_OS_HOME    REG_SZ    F:\Hermes\data
//
