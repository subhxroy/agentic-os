# nix/agentic-os.nix — Overridable Agentic OS package
#
...
stdenv.mkDerivation (finalAttrs: {
  ...
  installPhase = ''
    ...
    mkdir -p $out/share/agentic-os $out/bin
    ln -s ${bundledSkills} $out/share/agentic-os/skills
    ln -s ${bundledOptionalSkills} $out/share/agentic-os/optional-skills
    ...
    ${lib.concatMapStringsSep "\n"
      (name: ''
        makeWrapper ${hermesVenv}/bin/${name} $out/bin/${name} \
          ...
          --set HERMES_BUNDLED_SKILLS $out/share/agentic-os/skills \
          --set HERMES_OPTIONAL_SKILLS $out/share/agentic-os/optional-skills \
          --set HERMES_BUNDLED_PLUGINS $out/share/agentic-os/plugins \
          --set HERMES_BUNDLED_LOCALES $out/share/agentic-os/locales \
          --set HERMES_WEB_DIST $out/share/agentic-os/web_dist \
          --set AGENTIC_OS_TUI_DIR $out/ui-tui \
