# nix/overlays.nix — Expose pkgs.agentic-os for external NixOS configs
#
...
# `pkgs.agentic-os`, `nix build .#default`, and the NixOS module's
...
{ inputs, ... }:
{
  flake.overlays.default = final: _: {
    agentic-os = inputs.self.packages.${final.stdenv.hostPlatform.system}.default;
  };
}
