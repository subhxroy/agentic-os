 ...
 * session token into `index.html` (see `agentic_os_cli/web_server.py`). The
...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      "@agentic-os/shared": path.resolve(__dirname, "../apps/shared/src"),
    },
  ...
  build: {
    outDir: "../agentic_os_cli/web_dist",
    emptyOutDir: true,
  },
  server: {
    proxy: {
