...
export const es: Translations = {
  ...
  status: {
    ...
    stopped: "Detenido",
    updateHermes: "Actualizar Agentic OS",
    updatingHermes: "Actualizando Agentic OS…",
  ...
  pluginsPage: {
    ...
    headline:
      "Descubre, instala, habilita y actualiza complementos de Agentic OS (equivalente a `hermes plugins`).",
    ...
    removeConfirm: "¿Eliminar este complemento de ~/.agentic-os/plugins/?",
    removeHint: "Solo se pueden eliminar complementos instalados por el usuario en ~/.agentic-os/plugins.",
  ...
  skills: {
    ...
    filters: "Filtros",
    noSkills: "No se encontraron habilidades. Las habilidades se cargan desde ~/.agentic-os/skills/",
  ...
  env: {
    ...
    customHint: "Variables de entorno arbitrarias almacenadas en tu .env que Agentic OS no reconoce. Úsalas para inyectar variables de entorno para skills, servidores MCP o tus propias herramientas.",
  ...
  achievements: {
    hero: {
      ...
      title: "Agentic OS Achievements",
      subtitle:
        "Insignias coleccionables de Agentic OS ganadas a partir del historial real de sesiones. Los logros conocidos no completados se muestran como Descubiertos; los logros secretos permanecen ocultos hasta que aparece el primer comportamiento coincidente.",
      scan_subtitle:
        "Escaneando el historial de sesiones de Agentic OS. El primer escaneo puede tardar 5–10 segundos en historiales grandes.",
    },
    actions: {
    ...
    stats: {
      ...
      latest: "Más reciente",
      latest_hint_empty: "usa Agentic OS más",
    ...
    guide: {
      ...
      secret_body:
        "Los secretos ocultan su disparador exacto. Una vez que Agentic OS detecta una señal relacionada, la tarjeta pasa a Descubierto y muestra su requisito.",
      scan_status_header: "Estado del escaneo",
      scan_status_body:
        "Agentic OS está escaneando el historial local una vez, después las tarjetas aparecerán automáticamente. No hay nada bloqueado si tarda unos segundos.",
    ...
    share: {
      ...
      tweet_text: "Just unlocked {tier_part}\"{name}\" in Agentic OS ☤",
    },
  },
  kanban: {
