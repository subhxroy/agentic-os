...
interface AgenticOSConsoleModalProps {
  open: boolean;
  onClose: () => void;
}
...
export function AgenticOSConsoleModal({ open, onClose }: AgenticOSConsoleModalProps) {
  ...
  useEffect(() => {
    ...
    writeLine(term, "\x1b[2mConnecting to Agentic OS Console...\x1b[0m");
