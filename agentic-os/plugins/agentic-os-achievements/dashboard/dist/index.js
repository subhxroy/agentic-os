(function () {
  "use strict";
  // agentic-os-achievements dashboard plugin
  // Originally authored by @PCinkusz — https://github.com/PCinkusz/agentic-os-achievements (MIT).
  // Bundled into agentic-os. Upstream repo remains the staging ground for new
  ...
  function api(path, options) {
    ...
    const url = "/api/plugins/agentic-os-achievements" + path;
  ...
  async function buildShareImage(achievement) {
    ...
    ctx.fillText("AGENTIC OS  ·  agentic-os.nousresearch.com", 70, H - 40);
  ...
  function ShareDialog({ achievement, onClose }) {
    ...
    function tweetText() {
      ...
      const tmpl = tx(t, "share.tweet_text", "Just unlocked {tier_part}\"{name}\" in Agentic OS ☤", {
        tier_part: tierPart,
        name: achievement.name,
      });
      return tmpl + "\n\n@NousResearch · https://agentic-os.nousresearch.com";
    }
  ...
  window.__HERMES_PLUGINS__.register("agentic-os-achievements", AchievementsPage);
})();
