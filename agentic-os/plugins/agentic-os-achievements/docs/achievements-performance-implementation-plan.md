...
- Snapshot persisted at `~/.agentic-os/plugins/agentic-os-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.agentic-os/plugins/agentic-os-achievements/scan_checkpoint.json`.
