...
- persisted runtime files:
  - `~/.agentic-os/plugins/agentic-os-achievements/state.json` (existing unlock state)
  - `~/.agentic-os/plugins/agentic-os-achievements/scan_snapshot.json` (new)
  - `~/.agentic-os/plugins/agentic-os-achievements/scan_checkpoint.json` (new)
