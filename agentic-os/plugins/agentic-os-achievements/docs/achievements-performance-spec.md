...
Owner: agentic-os-achievements plugin
...
### `GET /api/plugins/agentic-os-achievements/achievements`
...
### `POST /api/plugins/agentic-os-achievements/rescan` (optional)
Manual refresh trigger.
Prefer async trigger + immediate status response.

### `GET /api/plugins/agentic-os-achievements/scan-status` (optional new)
Reports scan state for UX/ops.

### Removed
- `GET /api/plugins/agentic-os-achievements/overview`
...
- Persist plugin data under:
  - `~/.agentic-os/plugins/agentic-os-achievements/scan_snapshot.json`

### Phase 2
- Incremental scan checkpoints with per-session fingerprints.
- Persist checkpoint data under:
  - `~/.agentic-os/plugins/agentic-os-achievements/scan_checkpoint.json`
...
- `~/.agentic-os/plugins/agentic-os-achievements/`
