...
Behavioral settings (live in $AGENTIC_OS_HOME/mem0.json, set via `hermes memory
setup`):
...
def _load_config() -> dict:
    """Load config from env vars, with $AGENTIC_OS_HOME/mem0.json overrides.
...
class Mem0MemoryProvider(MemoryProvider):
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        #   1. Operator-configured MEM0_USER_ID (env or $AGENTIC_OS_HOME/mem0.json) —
