...
class MemoryStore:
    ...
    def __init__(
        ...
        if db_path is None:
            ...
            db_path = str(get_agentic_os_home() / "memory_store.db")
    ...
    def _init_db(self) -> None:
        ...
        # gracefully on NFS/SMB/FUSE-mounted AGENTIC_OS_HOME (same issue as
        # state.db / kanban.db — see agentic_os_state._WAL_INCOMPAT_MARKERS).
