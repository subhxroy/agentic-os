...
Let Agentic OS join a Google Meet call, transcribe it, optionally speak
...
| `node/registry.py` | v3: `$AGENTIC_OS_HOME/workspace/meetings/nodes.json` |
...
echo 'OPENAI_API_KEY=sk-...' >> ~/.agentic-os/.env
