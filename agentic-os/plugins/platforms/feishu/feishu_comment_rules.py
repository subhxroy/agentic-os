...
Config: ~/.agentic-os/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.agentic-os/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_agentic_os_home()`` helper (AGENTIC_OS_HOME-aware and
...
RULES_FILE = get_agentic_os_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_agentic_os_home() / "feishu_comment_pairing.json"
