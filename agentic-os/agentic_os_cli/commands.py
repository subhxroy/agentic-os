"""Slash command definitions and autocomplete for the Agentic OS CLI.
...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("reload-mcp", "Reload MCP servers from config", "Tools & Skills",
               aliases=("reload_mcp",)),
    CommandDef("reload-skills", "Re-scan ~/.agentic-os/skills/ for newly installed or removed skills",
    ...
    CommandDef("update", "Update Agentic OS to the latest version", "Info"),
    CommandDef("version", "Show Agentic OS version", "Info", aliases=("v",)),
...
def _iter_plugin_command_entries() -> list[tuple[str, str, str]]:
    ...
    :func:`agentic_os_cli.plugins.PluginContext.register_command`. They behave
...
def slack_app_manifest(request_url: str = "https://agentic-os.local/slack/commands") -> dict[str, Any]:
