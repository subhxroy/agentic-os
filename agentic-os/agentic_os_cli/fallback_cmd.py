...
Storage: ``fallback_providers`` in ``~/.agentic-os/config.yaml`` (top-level, list of
...
def _restore_auth_active_provider(value: Any) -> None:
    ...
    try:
        from agentic_os_cli.auth import _auth_store_lock, _load_auth_store, _save_auth_store
...
def cmd_fallback_list(args) -> None:  # noqa: ARG001
    ...
    print("  Docs: https://agentic-os.nousresearch.com/docs/user-guide/features/fallback-providers")
    print()
...
def cmd_fallback_add(args) -> None:
    ...
    from agentic_os_cli.main import _require_tty, select_provider_and_model
