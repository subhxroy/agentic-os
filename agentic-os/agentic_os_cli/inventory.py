...
def build_models_payload(
    ...
    *,
    ...
    try:
        from agentic_os_cli.providers import is_routing_aggregator as _is_routing_aggregator
    except Exception:
...
def _append_unconfigured_rows(
    ...
    *,
    ...
    from agentic_os_cli.models import CANONICAL_PROVIDERS, _PROVIDER_LABELS
...
def _moa_provider_row(current_provider: str = "") -> dict | None:
    ...
    picker path (:func:`agentic_os_cli.model_switch.list_picker_providers`) so the
