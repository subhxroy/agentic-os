...
they were not: the CLI picker read :data:`agentic_os_cli.models.CANONICAL_PROVIDERS`
...
* ``auth_type`` / ``api_key_env_vars`` / ``base_url_env_var`` from
  :data:`agentic_os_cli.auth.PROVIDER_REGISTRY` (credential truth), and
...
# agentic_os_cli.auth.PROVIDER_REGISTRY and providers.base.ProviderProfile.
