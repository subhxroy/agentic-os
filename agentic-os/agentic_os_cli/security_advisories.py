...
ADVISORIES: tuple[Advisory, ...] = (
    Advisory(
        ...
        remediation=(
            ...
            "Rotate API keys in ~/.agentic-os/.env (OpenRouter, Anthropic, OpenAI, "
...
# ``~/.agentic-os/cache/advisory_banner_seen`` (a single line per advisory ID:
...
def _banner_cache_path() -> Optional[Path]:
    try:
        ...
        cache_dir = Path(get_agentic_os_home()) / "cache"
