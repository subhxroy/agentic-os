...
convention. State lives in the per-profile ``$AGENTIC_OS_HOME/projects.db`` store
(see :mod:`agentic_os_cli.projects_db`).
...
def build_parser(
    ...
    p_create.add_argument("name", help="Human name, e.g. 'Agentic OS'")
