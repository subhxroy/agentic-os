...
configuration in ~/.agentic-os/config.yaml under the ``mcp_servers`` key.
"""
...
def _prompt(question: str, *, password: bool = False, default: str = "") -> str:
    from agentic_os_cli.cli_output import prompt as _shared_prompt
...
def _resolve_mcp_server_config(config: dict) -> dict:
    ...
    ``~/.agentic-os/.env`` into ``os.environ`` and recursively interpolate any
...
def cmd_mcp_add(args):
    ...
    # agentic_os_cli/main.py for why the dest is renamed.
