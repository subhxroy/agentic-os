import { Box, Text, useStdout } from '@agentic-os/ink'
...
const TAG_FULL = 'Agentic OS · Personal AI Agent'
const TAG_MID = 'Personal AI Agent'
const TAG_TINY = 'Agentic OS'
const HIDE_BELOW = 34
...
export function SessionPanel({ info, maxWidth, sid, t }: SessionPanelProps) {
  ...
  // agentic_os_cli/banner.py) and the "connected" label on the collapse toggle.
