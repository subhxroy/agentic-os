"""ACP agent server — exposes Agentic OS via the Agent Client Protocol."""
...
class HermesACPAgent(acp.Agent):
    ...
    def _build_model_state(self, state: SessionState) -> SessionModelState | None:
        ...
        try:
            from agentic_os_cli.models import curated_models_for_provider, normalize_provider, provider_label
    ...
    def _resolve_model_selection(raw_model: str, current_provider: str) -> tuple[str, str]:
        ...
        try:
            from agentic_os_cli.models import detect_provider_for_model, parse_model_input
    ...
    async def _send_session_info_update(
        ...
        *,
        ...
        # agentic_os_state.py schema — only started_at/ended_at). Use "now" as
    ...
    def _cmd_version(self, args: str, state: SessionState) -> str:
        return f"Agentic OS v{HERMES_VERSION}"
