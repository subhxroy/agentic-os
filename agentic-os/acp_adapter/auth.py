...
def detect_provider() -> Optional[str]:
    """Resolve the active Agentic OS runtime provider, or None if unavailable.
...
def has_provider() -> bool:
    """Return True if Agentic OS can resolve any runtime provider credentials."""
    return detect_provider() is not None


def build_auth_methods() -> list[Any]:
    """Return registry-compatible ACP auth methods for Agentic OS.
