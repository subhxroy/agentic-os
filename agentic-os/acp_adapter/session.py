...
Sessions are persisted to the shared SessionDB (``~/.agentic-os/state.db``) so they
...
class SessionManager:
    ...
    def __init__(self, agent_factory=None, db=None):
        ...
        Args:
            ...
            db:            Optional SessionDB instance. When omitted, the default
                           SessionDB (``~/.agentic-os/state.db``) is lazily created.
        """
    ...
    def _get_db(self):
        ...
        Note: we resolve ``AGENTIC_OS_HOME`` dynamically rather than relying on
        ...
        later (e.g. by the test fixture ``_isolate_agentic_os_home``).
        """
