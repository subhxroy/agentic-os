...
Module-level run.py helpers a handler needs (``_agentic_os_home``,
...
from agentic_os_cli.config import atomic_config_write, cfg_get, clear_model_endpoint_credentials
from utils import (
    atomic_json_write,
...
class GatewaySlashCommandsMixin:
    ...
    async def _handle_kanban_command(self, event: MessageEvent) -> str:
        ...
        import re
        import shlex
        from agentic_os_cli.kanban import run_slash
    ...
    async def _handle_restart_command(self, event: MessageEvent) -> Union[str, EphemeralReply]:
        ...
        from gateway.run import _agentic_os_home
        ...
        try:
            ...
            atomic_json_write(
                _agentic_os_home / ".restart_notify.json",
                notify_data,
                indent=None,
            )
        ...
        try:
            ...
            atomic_json_write(
                _agentic_os_home / ".restart_last_processed.json",
                dedup_data,
                indent=None,
            )
        except Exception as e:
    ...
    async def _handle_version_command(self, event: MessageEvent) -> str:
        """Handle /version — show the running Agentic OS version."""
    ...
    async def _handle_help_command(self, event: MessageEvent) -> str:
        ...
        from agentic_os_cli.commands import gateway_help_lines
        lines = [
    ...
    async def _handle_model_command(self, event: MessageEvent) -> Optional[str]:
        ...
        """
        from gateway.run import _agentic_os_home, _load_gateway_config
        import yaml
        ...
        custom_provs = None
        excluded_provs = []
        config_path = (_command_profile_home or _agentic_os_home) / "config.yaml"
        try:
            ...
            if has_picker:
                ...
                if providers:
                    ...
                    async def _on_model_selected_scoped(
                        ...
                        try:
                            from agentic_os_cli.context_switch_guard import (
    ...
    async def _handle_personality_command(self, event: MessageEvent) -> str:
        ...
        config_path = _agentic_os_home / 'config.yaml'
    ...
    async def _handle_goal_command(self, event: "MessageEvent") -> str:
        ...
        if lower.startswith("draft"):
            ...
            try:
                import asyncio
                from agentic_os_cli.goals import draft_contract
            ...
            from agentic_os_cli.goals import parse_contract
    ...
    def _reasoning_picker_choices(self, current_effort: str) -> list:
        ...
        from agentic_os_constants import VALID_REASONING_EFFORTS
    ...
    async def _handle_skills_command(self, event: MessageEvent) -> str:
        ...
        the pending JSON file under ``~/.agentic-os/pending/skills/``. (Note this is
        ...
        if args and args[0].lower() == "diff" and len(out) > 3000:
            ...
            out = (out[:3000]
                   + "\n… (truncated — full diff in "
                     f"~/.agentic-os/pending/skills/{pending_id}.json)")
        return out
    ...
    async def _handle_verbose_command(self, event: MessageEvent) -> str:
        ...
        """
        from gateway.run import _agentic_os_home, _load_gateway_config, _platform_config_key
    ...
    async def _handle_footer_command(self, event: MessageEvent) -> str:
        ...
        """
        from gateway.run import _agentic_os_home, _load_gateway_config, _platform_config_key, _resolve_gateway_model
    ...
    async def _handle_update_command(self, event: MessageEvent) -> str:
        """Handle /update command — update Agentic OS to the latest version.
        ...
        """
        from gateway.run import _agentic_os_home, _resolve_hermes_bin
        import json
        import shutil
        import subprocess
        from datetime import datetime
        from agentic_os_cli.config import is_managed, format_managed_message
        ...
        if is_managed():
            return f"✗ {format_managed_message('update Agentic OS')}"
        ...
        pending_path = _agentic_os_home / ".update_pending.json"
        output_path = _agentic_os_home / ".update_output.txt"
        exit_code_path = _agentic_os_home / ".update_exit_code"
        session_key = self._session_key_for_source(event.source)
        pending = {
