...
Connects Agentic OS to WeChat personal accounts via Tencent's iLink Bot API.
...
class WeixinAdapter(BasePlatformAdapter):
    ...
    async def _poll_loop(self) -> None:
        ...
        sync_buf = _load_sync_buf(self._agentic_os_home, self._account_id)
        ...
        while self._running:
            try:
                ...
                if new_sync_buf:
                    ...
                    _save_sync_buf(self._agentic_os_home, self._account_id, sync_buf)
...
async def send_weixin_direct(
    *,
    ...
    token_store = ContextTokenStore(str(get_agentic_os_home()))
