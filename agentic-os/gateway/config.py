...
# dashboard's pre-write mutation validation (agentic_os_cli/web_server.py) so
...
class GatewayConfig:
    ...
    # Storage paths
    sessions_dir: Path = field(default_factory=lambda: get_agentic_os_home() / "sessions")
...
def load_gateway_config() -> GatewayConfig:
    ...
    try:
        ...
        if config_yaml_path.exists():
            ...
            # through agentic_os_cli.config.load_config, so without this a managed
