#!/usr/bin/env python3
"""Google Workspace OAuth2 setup for Agentic OS.
...
from _agentic_os_home import display_agentic_os_home, get_agentic_os_home
...
PENDING_AUTH_PATH = AGENTIC_OS_HOME / "google_oauth_pending.json"
...
def install_deps():
    ...
    print("  pip install 'agentic-os[google]'")
...
def exchange_auth_code(code: str):
    ...
    print(f"Profile-scoped token location: {display_agentic_os_home()}/google_token.json")
