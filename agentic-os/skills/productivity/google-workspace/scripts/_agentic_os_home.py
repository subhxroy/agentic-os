"""Resolve AGENTIC_OS_HOME for standalone skill scripts.
...
instead of duplicating the ``AGENTIC_OS_HOME = Path(os.getenv(...))`` pattern.
"""
...
try:
    ...
    def get_agentic_os_home() -> Path:
        """Return the Hermes home directory (default: ~/.agentic-os).
