...
Plugins built on Agentic OS often need to make their own LLM calls
...
:class:`~agentic_os_cli.plugins.PluginContext`:
...
class PluginLlm:
    ...
    Instances are constructed by :class:`agentic_os_cli.plugins.PluginContext`
