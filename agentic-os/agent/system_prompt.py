...
def build_system_prompt_parts(agent: Any, system_message: Optional[str] = None) -> Dict[str, str]:
    ...
    # Some execution modes (cron) still want AGENTIC_OS_HOME persona while keeping
    ...
    # Pointer to the agentic-os skill + docs for user questions about Hermes itself.
    ...
    # under so it doesn't conflate ~/.agentic-os/skills/ (default profile) with
    # ~/.agentic-os/profiles/<active>/skills/ (this profile's). Deterministic
