...
Hermes stores sessions in its own SQLite store (``agentic_os_state.SessionDB``),
...
_NO_TOKEN_MESSAGE = (
    ...
    "2. Add it to your environment as HF_TOKEN (e.g. in ~/.agentic-os/.env):\n"
