...
from agentic_os_logging import set_session_context
...
def _ollama_context_limit_error(agent: Any, request_tokens: int) -> Optional[str]:
    ...
    return (
        ...
        f"context, but Agentic OS needs at least {MINIMUM_CONTEXT_LENGTH:,} tokens "
...
def run_conversation(
    ...
    if moa_config is None:
        try:
            from agentic_os_cli.moa_config import decode_moa_turn
    ...
    while (api_call_count < agent.max_iterations and agent.iteration_budget.remaining > 0) or agent._budget_grace_call:
        ...
        while retry_count < max_retries:
            ...
            try:
                ...
                try:
                    from agentic_os_cli.middleware import apply_llm_request_middleware
                ...
                from agentic_os_cli.middleware import run_llm_execution_middleware
                ...
                if retry_count >= max_retries:
                    ...
                    if _is_thinking_timeout:
                        ...
                        agent._vprint(
                            ...
                            f"in `~/.agentic-os/config.yaml` to extend the per-call "
        ...
        try:
            ...
            if assistant_message.tool_calls:
                ...
                try:
                    ...
                    from agentic_os_cli.plugins import get_pre_verify_continue_message, has_hook
