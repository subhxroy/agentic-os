...
class UIElement:
    ...
    # (trycua/cua#1961 — Surface 6 of subhxroy/agentic-os#47072).
...
class CaptureResult:
    ...
    # trycua/cua#1961 — Surface 7 of subhxroy/agentic-os#47072).
...
class ActionResult:
    ...
    verify → escalate ladder (subhxroy/agentic-os#67052). ``ok`` stays
