...
def test_main_version_prints_without_starting_server(monkeypatch, capsys):
    ...
    assert output
    assert "Starting agentic-os ACP adapter" not in output
...
def test_main_setup_runs_model_configuration(monkeypatch):
    ...
    monkeypatch.setattr("agentic_os_cli.main.main", fake_hermes_main)
...
def test_main_setup_offers_browser_install_when_tty(monkeypatch):
    ...
    monkeypatch.setattr("agentic_os_cli.main.main", lambda: None)
...
def test_main_setup_browser_calls_ensure_dependency(monkeypatch):
    ...
    monkeypatch.setattr("agentic_os_cli.dep_ensure.ensure_dependency", fake_ensure)
