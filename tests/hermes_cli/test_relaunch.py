"""Tests for agentic_os_cli.relaunch — unified self-relaunch utility."""

import sys

import pytest

from agentic_os_cli import relaunch as relaunch_mod
...
class TestBuildRelaunchArgv:
    ...
    def test_falls_back_to_python_module(self, monkeypatch):
        ...
        argv = relaunch_mod.build_relaunch_argv(["--resume", "abc"])
        assert argv == [sys.executable, "-m", "agentic_os_cli.main", "--resume", "abc"]
