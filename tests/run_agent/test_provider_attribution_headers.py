...
def test_openrouter_base_url_applies_or_headers(mock_openai):
    ...
    assert headers["HTTP-Referer"] == "https://agentic-os.nousresearch.com"
    assert headers["X-Title"] == "Agentic OS"
...
def test_user_default_headers_win_over_provider_defaults(mock_openai):
    ...
    assert headers["HTTP-Referer"] == "https://agentic-os.nousresearch.com"  # default preserved
