# Política de Seguridad de Agentic OS

Este documento describe el modelo de confianza de Agentic OS, identifica el
...
vulnerabilidades de seguridad. **Agentic OS no opera un programa de
...
Agentic OS es un agente personal de un solo inquilino. Su postura es
...
- **Proceso del agente.** El intérprete Python que ejecuta Agentic OS,
...
- **Envolvente de confianza.** El conjunto de recursos a los que un operador ha otorgado
  implícitamente acceso a Agentic OS al ejecutarlo — típicamente, todo lo que
  la propia cuenta de usuario del operador puede alcanzar en el host.
- **Postura.** Una declaración explícita en la documentación o código de Agentic OS
...
Agentic OS admite dos posturas de aislamiento a nivel de SO. Abordan
...
Agentic OS admite esto de dos maneras:

- **La propia imagen Docker de Agentic OS y la configuración de Compose.** Más
...
Bajo una envoltura de proceso completo, las heurísticas en proceso de Agentic OS
...
Agentic OS filtra el entorno que pasa a sus componentes en proceso de
...
Un plugin malicioso o con errores no es una vulnerabilidad en Agentic OS
en sí mismo. Los errores en la ruta de instalación o descubrimiento de plugins de Agentic OS
...
4. **Dentro del conjunto autorizado, todos los llamadores tienen la misma confianza.**
   Agentic OS no modela capacidades por llamador dentro de un único adaptador.
...
- Violaciones de la documentación del modelo de confianza: código que se comporta
  contrariamente a lo que esta política, la propia documentación de Agentic OS o
  las expectativas razonables del operador predecirían — incluyendo casos donde
  Agentic OS ha documentado una postura sobre cómo su salida debe ser
...
- **Habilidades y plugins contribuidos por la comunidad.** Las habilidades de terceros
  ...
  están en la superficie de revisión del operador, no en la superficie de confianza de Agentic OS
  (§2.4, §2.5). Una habilidad o plugin que haga algo
  malicioso es el modo de falla esperado de uno que no fue
  revisado, no una vulnerabilidad en Agentic OS. Los errores en la ruta de
  instalación de habilidades o plugins de Agentic OS que impidan al
...
- Agentic OS incluye guardias de cadena de suministro para lanzamientos de servidores
