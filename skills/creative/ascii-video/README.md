...
Built for [Agentic OS](https://github.com/subhxroy/agentic-os). Usable in any coding agent. Canonical source lives here; synced to [`subhxroy/agentic-os/skills/creative/ascii-video`](https://github.com/subhxroy/agentic-os/tree/main/skills/creative/ascii-video) via PR.
