...
Extracted from ``agentic_os_cli/main.py:main()`` (god-file Phase 2 follow-up).
...
def build_acp_parser(subparsers, *, cmd_acp: Callable) -> None:
    ...
    acp_parser = subparsers.add_parser(
        "acp",
        help="Run Agentic OS as an ACP (Agent Client Protocol) server",
        description="Start Agentic OS in ACP mode for editor integration (VS Code, Zed, JetBrains)",
    )
