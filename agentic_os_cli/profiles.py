...
_PROFILE_DIRS = [
    ...
    # See agentic_os_constants.get_subprocess_home().
    "home",
]
...
# (#58394). Add new artifacts here when introduced in ``agentic_os_constants``.
...
def create_profile(
    ...
    if not soul_path.exists():
        try:
            from agentic_os_cli.default_soul import DEFAULT_SOUL_MD
...
def _maybe_register_gateway_service(profile_name: str) -> None:
    ...
    try:
        ...
        from agentic_os_cli.service_manager import get_service_manager
