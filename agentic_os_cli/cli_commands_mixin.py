...
class CLICommandsMixin:
    ...
    def _handle_snapshot_command(self, command: str):
        ...
        """
        from agentic_os_cli.backup import (
    ...
    def _handle_paste_command(self):
        ...
        from agentic_os_cli.clipboard import has_clipboard_image
    ...
    def _handle_tools_command(self, cmd: str):
        ...
        def _run_capture(ns: Namespace) -> None:
            ...
            # Buffer reports isatty()=True so color() in agentic_os_cli/colors.py
    ...
    def _handle_resume_command(self, cmd_original: str) -> None:
        ...
        if target.isdigit():
            ...
            from agentic_os_cli.main import _resolve_session_by_name_or_id
    ...
    def _handle_pet_command(self, cmd: str):
        ...
        from agentic_os_cli.pets import _set_active, _set_enabled, print_pet_gallery, set_pet_scale, toggle_pet_display
    ...
    def _handle_suggestions_command(self, cmd: str):
        ...
        args = " ".join(tokens)
        try:
            from agentic_os_cli.suggestions_cmd import handle_suggestions_command
    ...
    def _handle_blueprint_command(self, cmd: str):
        ...
        try:
            from agentic_os_cli.blueprint_cmd import handle_blueprint_command
    ...
    def _handle_curator_command(self, cmd: str):
        ...
        Delegates to agentic_os_cli.curator so the CLI and the `hermes curator`
        ...
        try:
            from agentic_os_cli.curator import cli_main
            cli_main(tokens)
        except SystemExit:
    ...
    def _handle_skills_command(self, cmd: str):
        """Handle /skills slash command — delegates to agentic_os_cli.skills_hub."""
        ...
        if args and args[0].lower() in {"pending", "approve", "apply", "reject",
            ...
            if out is not None:
                print(out)
                return
        from agentic_os_cli.skills_hub import handle_skills_slash
    ...
    def _handle_skin_command(self, cmd: str):
        ...
        try:
            from agentic_os_cli.skin_engine import list_skins, set_active_skin, get_active_skin_name
        except ImportError:
    ...
    def _handle_fast_command(self, cmd: str):
        ...
        try:
            from agentic_os_cli.models import _is_anthropic_fast_model
    ...
    def _handle_update_command(self) -> bool:
        """Handle /update — update Agentic OS to the latest version.
        ...
        if is_managed():
            print(f"  ✗ {format_managed_message('update Agentic OS')}")
            return False
        ...
        choices = [
            ("once", "Update Now", "exit the current session and update Agentic OS"),
            ("cancel", "Cancel", "keep the current session"),
        ]
        raw = self._prompt_text_input_modal(
            title="▸  Update Agentic OS",
