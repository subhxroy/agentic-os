...
* This module intentionally mirrors ``agentic_os_cli/goals.py`` — same aux
...
_SYSTEM_PROMPT = """You are the Kanban triage specifier for the Agentic OS board.
...
def _profile_author() -> str:
    """Mirror of ``agentic_os_cli.kanban._profile_author``. Kept local to
